...
<body class="dark__background">
    ...
    <main class="main__container">
        <section class="cover">
            ...
            <div class="cover__wrapper__2 secondary__background">
                ...
                <a href="" class="middle__icon">
                    <img src="assets/icons/video__icon.png" alt="">
                </a>
        ...
        <section class="partners light__background section__container">
            <h2 class="partners__title section__title primary__color">
                nos partenaires
            </h2>
    ...
    <footer class="footer">
        ...
        <div class="footer__part__2 secondary__background">
